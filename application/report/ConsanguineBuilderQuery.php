...
class ConsanguineBuilderQuery extends BuilderQueryAbstract
{
	...
	protected static $tables = array(
		CLS_CONSANGUINE => array(
				self::_PREFIX => self::CONSANGUINE_PREFIX,
				self::_MAIN_TABLE_KEY => TRUE,
				self::_REFERENCE_FIELDS_KEY => array(
					CLS_CONSANGUINETYPE => array(
										self::CONSANGUINE_PREFIX => CSG_ID_CONSANGUINE_TYPE,
										self::CONSANGUINETYPE_PREFIX => CTP_ID_CONSAGUINE_TYPE)
										)
				),
		CLS_CONSANGUINETYPE => array(self::_PREFIX => self::CONSANGUINETYPE_PREFIX),
	);
	...
	public static function getInstance()
	{
        ...
        {
        	self::$instance = new ConsanguineBuilderQuery();
    	}
