...
class TelephoneBuilderQuery extends BuilderQueryAbstract
{
	private static $instance;
	
	protected static $tables = array(
		CLS_TELEPHONENUMBER => array(
				parent::_PREFIX => parent::TELEPHONE_PREFIX,
				self::_MAIN_TABLE_KEY => TRUE,
				self::_REFERENCE_FIELDS_KEY => array(
					CLS_TELEPHONETYPE => array(
										parent::TELEPHONE_PREFIX => TNB_ID_TELEPHONE_TYPE, 
										parent::TELEPHONETYPE_PREFIX => TTP_ID_TELEPHONE)
										)
				),
		CLS_TELEPHONETYPE => array(parent::_PREFIX => parent::TELEPHONETYPE_PREFIX)
	);
	...
	public static function getInstance()
	{
        ...
        {
        	self::$instance = new TelephoneBuilderQuery();
    	}
