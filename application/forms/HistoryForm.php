 ...
 * 
 */
define('F_HISTORY_ID',	'history_id');

class HistoryForm extends BasicForm
{
	/**
	 * Campos
	 */
	 ...
	 * 
	 */
	public static function historyId(){return F_HISTORY_ID;}
	...
	public function assembleRequest(&$_request)
	{
		...
		$this->historyId			= $_request->getParam(HistoryForm::historyId());
	}
